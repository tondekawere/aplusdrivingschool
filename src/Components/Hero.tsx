  ...
  return (
    ...
    >
      <Grid item xs={12} sm={12} md={6} sx={{ margin: "auto", color: "#fff" }}>
        ...
        >
          At A Plus Driving School, we're more than just a place to learn how to
          drive - we're your partners on the journey to becoming a safe,
          skilled, and confident driver. We're dedicated to providing high-quality driving
          education and training services that empower individuals to navigate
          the roads with ease and confidence.
        </Typography>
        <Grid
          item
          xs={12}
